...
def run_cascaded_pipeline(
    ...
    # Create YAML configuration dictionary for the diarization pipeline. This config will be passed to the NeuralDiarizer, which will read the settings for each stage of the pipeline (VAD, embeddings, clustering) and execute accordingly.
...
EXAMPLES:
  ...
  python scripts/run_cascaded.py --audio data/meeting.wav --num-speakers 3
    ...
    parser.add_argument("--msdd-model", default="diar_msdd_telephonic", help="MSDD model name or .nemo path")
